    ...
    <div class="container mx-auto flex flex-wrap py-6">
        <section class="w-full md:w-2/3 flex flex-col items-center px-3">
            <div class="" section-language="en">
                <div id="md_en" data-target="out_en" class="agreement_md"><h1 class="text-3xl font-bold mb-3">Privacy Policy</h1>
                    ...
                    <h1 class="text-3xl font-bold mb-3">Interpretation and Definitions</h1>
                    <h2 class="text-2xl font-bold mb-3">Interpretation</h2>
                    ...
                    <h2 class="text-2xl font-bold mb-3">Definitions</h2>
                    ...
                    <ul class="list-disc">
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;,
                                &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Mentoring Heroes.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to Mentoring Heroes, accessible from <a
                                    href="https://www.mentoringheroes.com" rel="external nofollow noopener" target="_blank">https://www.mentoringheroes.com</a>
                            </p>
                        </li>
                        <li>
                    ...
                    <h1 class="text-3xl font-bold mb-3">Collecting and Using Your Personal Data</h1>
                    <h2 class="text-2xl font-bold mb-3">Types of Data Collected</h2>
                    <h3 class="text-1xl">Personal Data</h3>
                    ...
                    <h3 class="text-1xl">Usage Data</h3>
                    ...
                    <h3 class="text-1xl">Information from Third-Party Social Media Services</h3>
                    ...
                    <h3 class="text-1xl">Tracking Technologies and Cookies</h3>
                    ...
                    <h2 class="text-2xl font-bold mb-3">Use of Your Personal Data</h2>
                    ...
                    <h2 class="text-2xl font-bold mb-3">Retention of Your Personal Data</h2>
                    ...
                    <h2 class="text-2xl font-bold mb-3">Transfer of Your Personal Data</h2>
                    ...
                    <h2 class="text-2xl font-bold mb-3">Disclosure of Your Personal Data</h2>
                    <h3 class="text-1xl">Business Transactions</h3>
                    ...
                    <h3 class="text-1xl">Law enforcement</h3>
                    <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required
                        ...
                        agency).</p>
                    <h3 class="text-1xl">Other legal requirements</h3>
                    ...
                    <h2 class="text-2xl font-bold mb-3">Security of Your Personal Data</h2>
                    <p>The security of Your Personal Data is important to Us, but remember that no method of transmission
                        ...
                        security.</p>
                    <h1 class="text-3xl font-bold mb-3">Children's Privacy</h1>
                    ...
                    <p>If We need to rely on consent as a legal basis for processing Your information and Your country
                        ...
                        information.</p>
                    <h1 class="text-3xl font-bold mb-3">Links to Other Websites</h1>
                    ...
                    <h1 class="text-3xl font-bold mb-3">Changes to this Privacy Policy</h1>
                    ...
                    <ul class="list-disc">
                        <li>By email: <a href="/cdn-cgi/l/email-protection" class="__cf_email__"
                                         data-cfemail="9be2f4eee9fceef2fffedbf6fef5eff4e9f2f5fcf3fee9f4fee8b5f8f4f6">[email&#160;protected]</a>
                        </li>
                    </ul>
                </div>
...
<script type="text/javascript" src="/public/livelink/vendors/jquery.min.js"></script>
